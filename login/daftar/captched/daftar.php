...
{   
    if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])){
        $secretKey = '6LchHhoaAAAAAPQuoxhYwxyIhsK5fhZfo6hNDOCy';
    ...
    if(empty($username) || empty($nama) || empty($password))
    {
        ...
        header("location:register.php?pesan=Verifikasi gagal. Ulangi lagi!");
        die;
    }
    } else{
        header("location:register.php?pesan=Tolong selesaikan box captcha!");
        die;
    }
}
