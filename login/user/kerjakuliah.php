    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Menampilkan Data Alumni Dengan Status <strong>Kerja bersamaan dengan
                        Kuliah</strong></p>
            </div>
        </section>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Nama Perusahaan: <?php echo $row['nama_perusahaan']; ?></p>
                                <p class="card-text">Jabatan: <?php echo $row['jabatan']; ?></p>
                                <p class="card-text">Tahun Kerja: <?php echo $row['tahun_kerja']; ?></p>
                                <p class="card-text">Nama Universitas: <?php echo $row['uni_ver']; ?></p>
