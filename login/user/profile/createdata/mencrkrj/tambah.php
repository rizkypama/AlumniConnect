...
<html lang="en">
<head>
	<title>Request Data Mencari Kerja</title>
	<meta charset="UTF-8">
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" enctype="multipart/form-data" method="POST">
				...
				<div class="wrap-input100 validate-input" data-validate="Masukkan Alasan!">
                    <span class="label-input100">Alasan cari kerja</span>
                    <textarea class="input100" name="alasan" placeholder="Masukkan alasanmu!"></textarea>
					<span class="focus-input100"></span>
				</div>
...
<!--===============================================================================================-->
	...
	<script src="../../../../admin/crudmencrkrj/js/val.js"></script>
