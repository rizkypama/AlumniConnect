...
if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $query = "INSERT INTO request (jenis_table,nama,jenis_kelamin,alamat,kontak,alasan,requested_by,gambar) values ('mencari_kerja','$nama_mencrkrj','$jenis_kelamin','$alamat','$kontak','$alasan','$nameuser','$nama_gambar_baru')";
        ...
        $query =  "INSERT INTO request (jenis_table,nama,jenis_kelamin,alamat,kontak,alasan,requested_by,gambar) values ('mencari_kerja','$nama_mencrkrj','$jenis_kelamin','$alamat','$kontak','$alasan','$nameuser',null)";
        $result = mysqli_query($koneksi, $query);
        if(!$result) {
            die ("Query gagal dijalankan: ".mysqli_errno($koneksi).
            " - ".mysqli_error($koneksi));
