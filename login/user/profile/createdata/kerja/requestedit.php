...
if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $query = "INSERT INTO requestedit (id_request,jenis_table,nama,jenis_kelamin,nama_perusahaan,jabatan,tahun_kerja,request_by,gambar) values ('$id_request','kerja','$nama_kerja','$jenis_kelamin','$nama_perusahaan',
