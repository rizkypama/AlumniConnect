...
if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $query = "INSERT INTO request (jenis_table,nama,jenis_kelamin,nama_perusahaan,jabatan,tahun_kerja,nama_univer,jurusan,requested_by,gambar) values ('kerjakuliah','$nama_kerkul','$jenis_kelamin','$nama_perusahaan',
