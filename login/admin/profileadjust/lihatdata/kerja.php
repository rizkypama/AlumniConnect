          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-8">
                <p>Photo: (Jika ada)</p>
                <?php if($data['gambar'] != ""){ ?>
                <img src="../../crud/gambar/<?php echo $data['gambar'];?>" alt="tidak ada foto." style="width:200px;height:195px;">
                <?php } ?>
              </div>
              <div class="col-6 col-md-4">
                <p class="alert alert-warning">Jenis Tabel: Kerja</p>
              </div>
            </div>
            <br>
            <div class="row">
