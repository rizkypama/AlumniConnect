            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 13px;">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 80px">Jenis Usaha</th>
                            <th style="width: 75px;">Alamat Usaha</th>
                            <th style="width: 55px;">Tahun Usaha</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
									...
									$querydata = mysqli_query($koneksi,"SELECT * FROM usaha limit $main_page, $limit");
									$no = 1;
                        ...
                        <tr>
                            ...
                            <td style="width: 80px;"><?= $log['jenis_usaha'];?></td>
                            <td style="width: 75px"><?= $log['alamat_usaha'];?></td>
                            <td style="width: 55px"><?= $log['tahun_usaha'];?></td>
                        </tr>
                    <?php 
                    $no++;
                    }
